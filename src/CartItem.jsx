...
// Se importó addItem para cumplir con las instrucciones
...
const CartItem = ({ onContinueShopping }) => {
  ...
  // 1. Costo de todos los artículos en el carrito
  ...
  // 4. Decrementar (con if-else para eliminar si llega a 0)
